...
function makeBaddies() {
  ...
  for(let i=0;i<baddies.length;i++){
    ...
    unorderedList.appendChild(baddy)
    baddy.classList.add('baddy')
  // remember to append them to Mordor
  }
  document.querySelector('#Mordor').appendChild(unorderedList)
}
...
function makeBuddies () {
  ...
  for (let i=0; i<buddies.length;i++){
    ...
    unorderedList.appendChild(buddy)
...
function leaveTheShire() {
  ...
  const hobbits = document.querySelector('ul','.hobbit')
...
function forgeTheFellowShip() {
  ...
  for (let i=0; i<hobbits.length;i++){
    const hobbit = document.createElement('p')
  ...
  for (let i=0; i<buddies.length;i++){
    const buddy = document.createElement('p')
    buddy.innerText = buddies[i]
...
function theBalrog() {
  console.log("9: theBalrog");
   ...
   gandalf.innerText = 'Galdalf the White'
...
function hornOfGondor() {
 ...
 const boromir = document.querySelectorAll('p')[8]
 boromir.remove()
}
...
function itsDangerousToGoAlone() {
  ...
  const frodo = document.querySelectorAll('p')[0]
  const sam = document.querySelectorAll('p')[1]
...
function thereAndBackAgain() {
  ...
  const shire = document.querySelector("#The-Shire ul");
  for (let i = 0; i < hobbits.length; i++) {
